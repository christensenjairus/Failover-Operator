...
// Manager reconciles a Failover object
type Manager struct {
	client.Client
	...
	if clusterName != failover.Spec.TargetCluster && !syncMode && failover.Spec.TargetCluster != "" {
		...
		if err == nil {
			...
			if shouldUpdateFromTarget(failover, targetFO) {
				...
				syncCtx = context.WithValue(syncCtx, controller.FailoverKey, targetFO)
...
func (r *Manager) syncToOtherClusters(ctx context.Context, failover *crdv1alpha1.Failover) {
...
func (r *Manager) watchClusterResources(ctx context.Context, clusterName string, cl cluster.Cluster) {
...
func (r *Manager) reconcileFailover(ctx context.Context, logger logr.Logger, failover *crdv1alpha1.Failover) error {
...
func (r *Manager) reconcileFailoverInCluster(ctx context.Context, logger logr.Logger, failover *crdv1alpha1.Failover, clusterName string, targetClient client.Client) error {
